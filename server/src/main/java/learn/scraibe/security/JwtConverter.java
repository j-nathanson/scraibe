...
public class JwtConverter {
    ...
    private final String ISSUER = "scribe";
    ...
    public AppUser getUserFromToken(String token) {
        ...
        try {
            ...
            //TODO might need to change last parameter
            return new AppUser(appUserId, username, null,
                    null, true, Arrays.asList(authStr.split(",")), null);
